package com.peiyp.brainutumorsegmentation.service.impl;
...
import com.peiyp.brainucommon.entity.BrainFile;
...
import com.peiyp.brainutumorsegmentation.feign.ModelFeignService;
import com.peiyp.brainutumorsegmentation.feign.UserFeignService;
...
import com.peiyp.brainutumorsegmentation.service.SegmentService;
...
public class SegmentServiceImpl implements SegmentService {
    ...
    public String folderUpload(List<MultipartFile> files, PatientInfo patientInfo) {
        ...
        R r = userFeignService.insert(patientInfo);
    ...
    public String segment(String modelId, String patientId, HttpServletRequest request) {
        ...
        R r = modelFeignService.getModelById(modelId);
        ModelInfo data = r.getData("data", new TypeReference<ModelInfo>() {});
        ...
        try {
            ...
            path = split[0];
            if (!serverMsg.equals("")) {
                PatientInfo patientInfo = userFeignService.getPatientById(Long.parseLong(patientId));
                ...
                userFeignService.insert(patientInfo);
